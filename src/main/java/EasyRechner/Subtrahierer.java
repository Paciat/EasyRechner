 ...
 */
public class Subtrahierer implements Berechenbar {
    ...
    public double berechnen() {
        if (zahl1 < Double.POSITIVE_INFINITY && zahl2 < Double.POSITIVE_INFINITY && zahl1 > Double.NEGATIVE_INFINITY && zahl2 > Double.NEGATIVE_INFINITY && zahl1-zahl2 > Double.NEGATIVE_INFINITY && zahl1-zahl2 < Double.POSITIVE_INFINITY)
{
    ...
    //&& zahl1 - zahl2 >= Double.MIN_VALUE&& zahl1 >= Double.MIN_NORMAL && zahl2 >= Double.MIN_NORMAL
